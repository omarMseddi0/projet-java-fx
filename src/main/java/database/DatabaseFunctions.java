...
public class DatabaseFunctions {
    ...
    private static final String dbUrl = "jdbc:mysql://localhost:3306/defaultdb"; // Replace 'localhost' with the server IP if remote
    private static final String dbUsername = "root"; // Default username
    private static final String dbPassword = ""; // Replace with your MySQL root password
